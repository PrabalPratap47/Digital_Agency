...
const Teams = () => {
  return (
    ...
    className='flex-col flex items-center gap-7 px-4 sm:px-12 lg:px-24 xl:px-40 pt-30 text-gray-700 dark:text-white'>
        <Title 
        title='Meet Our Team'
        description='Our team of digital marketing experts is dedicated to helping your business succeed in the online world.'>
        </Title>
                ...
                key={index} className='flex max-sm:flex-col items-center gap-5 p-4 
                 ...
                 hover:scale-110 transition-all duration-400'>
                    ...
                    <div className='flex-1'>
                        <h3 className='text-bold text-sm'>{team.name}</h3>
